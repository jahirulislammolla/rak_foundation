<x-app-layout>
            ...
            <div class="d-flex overflow-hidden" 
                ...
                <div class="col-lg-6">
                    <div class="position-relative h-100">
                        <img style="z-index: 1;" class="position-absolute w-100 h-100 rounded" data-wow-delay="0.9s"
                            src="{{ asset('img/donation.png') }}" style="object-fit: cover;" />
                    </div>
                </div>
                <div class="col-lg-6 py-20 px-5" style="padding: 70px 0px;">
                    <div class="section-title position-relative pb-3 mb-5">
                        <h2 class="mb-0">Uplifting Lives with Compassion, Education, and Care</h1>
                    </div>
                    <p class="text-gray-700 mb-3">
                        At RAK Foundation, we run vital programs focused on education, healthcare, and humanitarian
                        support for underserved communities. These programs are designed to uplift and empower lives by
                        addressing core needs.
                    </p>
                    <p class="text-gray-700 mb-3">
                        Over the years, we have positively impacted thousands of lives through school sponsorships, free
                        health camps, and emergency relief initiatives. Your contribution makes this possible.
                    </p>

                    <a class="btn btn-primary py-3 px-5 mt-3 wow zoomIn" data-wow-delay="0.9s" href="quote.html">Sponsor Now</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                <h1 class="fw-bold text-primary text-uppercase">Our Focous Area</h1>
            </div>
            <div class="row g-5">
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.3s">
                    <div
                        class="service-item bg-light bg-hover-primary shadow-css rounded d-flex flex-column align-items-center justify-content-center text-center"
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.3s">
                    <div
                        ...
                        <h4 class="mb-3">Support People</h4>
                        <p class="m-0">Amet justo dolor lorem kasd amet magna sea stet eos vero lorem ipsum dolore sed
                        </p>
                        <a class="btn btn-lg btn-primary rounded" href="">
                            <i class="bi bi-arrow-right"></i>
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.9s">
                    <div
                        ...
                        <h4 class="mb-3">Social Welfare</h4>
                        <p class="m-0">Amet justo dolor lorem kasd amet magna sea stet eos vero lorem ipsum dolore sed
                        </p>
                        <a class="btn btn-lg btn-primary rounded" href="">
                            <i class="bi bi-arrow-right"></i>
                    ...
                    <div class="bg-light rounded">
                        ...
                        <div class="p-5 pt-0">
                            ...
                            <div class="d-flex justify-content-between mb-2"><span>Cross-browser Support</span><i
                                    class="fa fa-times text-danger pt-1"></i></div>
                            <a class="btn btn-primary py-2 px-4 mt-4" href="">Order Now</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-5">
                    <div class="bg-primary rounded h-100 d-flex align-items-center p-5 wow zoomIn"
                        ...
                        <form>
                            <div class="row g-3">
                                <div class="col-xl-12">
                                    <input class="form-control bg-light border-0" placeholder="Your Name"
                                        style="height: 55px;" type="text" />
                                </div>
                                <div class="col-12">
                                    <input class="form-control bg-light border-0" placeholder="Your Email"
                                        style="height: 55px;" type="email" />
                                </div>
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <textarea class="form-control bg-light border-0" placeholder="Message"
                                        rows="3"></textarea>
                                </div>
                                <div class="col-12">
        ...
        <div class="container py-5">
            ...
            <div class="row g-5">
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
                    <div class="team-item bg-light rounded overflow-hidden">
                        <div class="team-img position-relative overflow-hidden">
                            <img alt="" class="img-fluid w-100" src="{{ asset('img/team-1.jpg') }}" />
                ...
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.6s">
                    <div class="team-item bg-light rounded overflow-hidden">
                        <div class="team-img position-relative overflow-hidden">
                            <img alt="" class="img-fluid w-100" src="{{ asset('img/team-2.jpg') }}" />
                            <div class="team-social">
                                <a class="btn btn-lg btn-primary btn-lg-square rounded" href=""><i
                                        class="fab fa-twitter fw-normal"></i></a>
                                <a class="btn btn-lg btn-primary btn-lg-square rounded" href=""><i
                ...
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.9s">
                    <div class="team-item bg-light rounded overflow-hidden">
                        <div class="team-img position-relative overflow-hidden">
                            <img alt="" class="img-fluid w-100" src="{{ asset('img/team-3.jpg') }}" />
                            <div class="team-social">
                                <a class="btn btn-lg btn-primary btn-lg-square rounded" href=""><i
                                        class="fab fa-twitter fw-normal"></i></a>
                                <a class="btn btn-lg btn-primary btn-lg-square rounded" href=""><i
