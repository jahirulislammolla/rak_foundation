        ...
        <div class="carousel" data-bs-ride="carousel" id="header-carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img alt="Image" class="w-100  animate-zoom" style="height: calc(100svh / 2);" src="{{ asset($settings['our_work_image'] ?? '') }}" />
    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            ...
            <div class="mb-3 d-flex flex-wrap gap-2">
                ...
                <a href="{{ route('works.index', $baseQuery + ['range' => $key]) }}" class="btn {{ (string)$currentRange === (string)$key ? 'btn-primary' : 'btn-outline-primary' }}">
                    {{ $label }}
                </a>
                @endforeach
            </div>
                    ...
                    <div class="blog-item bg-light rounded overflow-hidden">
                        <div class="blog-img position-relative overflow-hidden">
                            <a class="text-uppercase" href="{{ route('works.index', ['slug' => $work->slug ]) }}">
                                ...
                                @if($work->category)
                                <span class="position-absolute top-0 start-0 bg-primary text-white rounded-end mt-5 py-2 px-4" href="#">
                                    {{ $work->category->name }}
                                </span>
                                @endif
                            </a>
