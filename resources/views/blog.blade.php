...
<a class="dropdown-item active" href="blog.html">Blog Grid</a>
...
<a class="h5 text-white" href="">Blog Grid</a>
</div>
</div>
</div>
</div>
...
<a aria-label="Previous" class="page-link rounded-0" href="#">
...
<li class="page-item">
<a aria-label="Next" class="page-link rounded-0" href="#">
