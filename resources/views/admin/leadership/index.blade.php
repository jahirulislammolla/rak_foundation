...
@include('admin.leadership.form', [
    'leadership' => new \App\Models\Leadership(),
...
<script type="text/javascript">
    ...
    const searchInput = document.getElementById('search_leadership');
    ...
    function search(page = 1) {
        ...
        const url = new URL('/manage-leaderships', window.location.origin);
    ...
    $("body").on("keyup", "#search_leadership", function(){
        search({{ request()->input('page') ?? 1 }})
    });
    ...
    $('input[name="leadership_type"]').on('change', function(){
