...
<script type="text/javascript">
    ...
    const searchInput = document.getElementById('search_award');
    ...
    function search(page = 1) {
        ...
        const url = new URL('/manage-awards', window.location.origin);
    ...
    $("body").on("keyup", "#search_award", function(){
        search({{ request()->input('page') ?? 1 }})
    });
    ...
    $('input[name="award_type"]').on('change', function(){
