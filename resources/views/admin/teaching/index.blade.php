...
@include('admin.teaching.form', [
    'teaching' => new \App\Models\Teaching(),
...
<script type="text/javascript">
    ...
    const searchInput = document.getElementById('search_teaching');
    ...
    function search(page = 1) {
        ...
        const url = new URL('/manage-teachings', window.location.origin);
    ...
    $("body").on("keyup", "#search_teaching", function(){
        search({{ request()->input('page') ?? 1 }})
    });
    ...
    $('input[name="teaching_type"]').on('change', function(){
