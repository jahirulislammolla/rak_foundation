<x-admin-layout>
    <div class="py-2 flex justify-between align-center">
        <button type="button" class="px-4 py-1.5 rounded bg-sky-500 text-white">
            Messages
        </button>
        <div class="text-left">
            <input type="text" 
    ...
    <script type="text/javascript">
        ...
        const searchInput = document.getElementById('search_message');
        ...
        function search(page = 1) {
            ...
            const url = new URL('/manage-messages', window.location.origin);
        ...
        $("body").on("keyup", "#search_message", function(){
            search({{ request()->input('page') ?? 1 }})
        });
