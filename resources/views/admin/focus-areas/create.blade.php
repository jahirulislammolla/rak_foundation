...
<x-admin-layout>
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6">
        <div class="mb-4 flex items-center justify-between">
            <h1 class="text-2xl font-bold">Add Focus Area</h1>
        ...
        <div class="rounded-2xl bg-white p-6 border">
            <form method="POST" action="{{ route('manage-focus-area.store') }}" enctype="multipart/form-data">
                @csrf
                @include('admin.focus-areas._form', ['item' => $item, 'isEdit' => false])
            </form>
        </div>
    </div>
</x-admin-layout>
