...
@include('admin.outreach.form', [
    'outreach' => new \App\Models\Outreach(),
...
<script type="text/javascript">
    ...
    const searchInput = document.getElementById('search_outreach');
    ...
    function search(page = 1) {
        ...
        const url = new URL('/manage-outreachs', window.location.origin);
    ...
    $("body").on("keyup", "#search_outreach", function(){
        search({{ request()->input('page') ?? 1 }})
    });
    ...
    $('input[name="outreach_type"]').on('change', function(){
